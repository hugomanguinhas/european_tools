...
import eu.europeana.pf2.db.TierEntry;
import eu.europeana.pf2.db.TierEntryConstants;
import eu.europeana.pf2.db.type.MediaTypeConverter;
import eu.europeana.pf2.media.MediaClassifier;
...
public class TierClassifier implements TierEntryConstants
{
    ...
    {
        _mh.harvestBySearch(getDatasetQuery(datasets), _chdl);
    }
